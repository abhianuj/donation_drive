...
import {AppBar, Button, ButtonGroup, CssBaseline, Slide, Toolbar, useScrollTrigger} from '@mui/material';
                    ...
                    <AppBar position="fixed" sx={styles.appbar}>
                        <Toolbar sx={{display: 'flex',
                            ...
                            <div style={styles.navigation}>
                                ...
                                <Button variant="outlined" disableElevation sx={{marginLeft: '1.2rem'}}><Link style={{textDecoration: 'none',
                                    color: '#1976d2'}} to="/auth/fundraise">Start a Fundraiser</Link></Button>
                                {authenticated
